        ...
        <div id="app-menu" class="offset-lg-3 col-lg-6">
            ...
            <div id='jqxMenu'>
                <ul>
                    ...
                    <li>Individu
                        <ul>
                            <li><a class="no-permission">Chercher un Individu</a></li>
                            <li><a class="no-permission">Créer un Individu</a></li>
                            <li style="color: rgb(148, 176,202);cursor: default;">---------------------</li>
                            <li><a class="no-permission">Chercher un Type d'Individu</a></li>
                            <li><a class="no-permission">Créer un Type d'Individu</a></li>
                        </ul>
                    </li>
                    <li>Documents
                        <ul>
                            <li><a class="no-permission">Chercher un Type de Document</a></li>
