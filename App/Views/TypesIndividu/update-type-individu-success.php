<?php
/**
 * File of the update-type-individu-success.php view
 ...
 * Dummy class
 */
class UpdateTypeIndividuSuccess{}
?>
...
<div class="row">
    ...
    <div id="page-title" class="offset-lg-3 col-lg-6">
        <div class="container">
            <div class="row">
                <div class="col">
                    <h5 style="text-align: center">Mise à jour avec succès</h5>
                </div>
            </div>
        </div>
    </div>
    ...
    <div id="main-panel"  class="offset-lg-3 col-lg-6">
        ...
        <div class="container">
            <div class="alert alert-success alert-dismissible fade show">
                Le type d&apos;individu a bien été mis à jour !
            </div>
        </div>
    </div>
</div>
